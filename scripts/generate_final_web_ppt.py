...
<section class="slide accent" data-layout="S01" data-animate="hero">
  <div class="canvas-card">
    ...
    <div class="course-cover-copy" data-anim="up">
      <div class="t-meta" style="color:rgba(255,255,255,.72);letter-spacing:.22em">RUL Prediction · Course Defense</div>
      ...
      <div class="half b-grey" style="justify-content:center">
        <div data-anim="rules" style="display:flex;flex-direction:column;gap:3vh">
          ...
          <div class="mini-ledger">
            ...
            <div><b>边界</b><span>本次答辩主线是 RUL 回归预测，不展开离散状态分类。</span></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="canvas-card" style="padding:0;display:flex;flex-direction:column;overflow:hidden">
    ...
    <div data-anim="kpi" class="image-hero-body course">
      ...
      <div class="image-hero-stats course">
        ...
        <div class="course-stat"><div style="height:1px;background:var(--ink)"></div><div class="t-meta">RMS</div><div class="kpi-hero" style="font-size:min(4.6vw,7.5vh);font-weight:200;line-height:.96;letter-spacing:-.04em;color:var(--accent)">0.56→5.61</div><div style="height:1px;background:var(--border-subtle);margin-top:auto"></div><p class="body-sm">后期强度和冲击变化更明显</p></div>
      </div>
    </div>
  </div>
</section>
...
<section class="slide" data-layout="S21" data-animate="tech-spec">
  <div class="canvas-card">
    <div class="chrome-min">
      <div class="l">RUL 模型与复现实验设计</div>
      <div class="r">11 / {TOTAL_SLIDES:02d}</div>
    </div>
    <div class="head-stack" data-anim="line">
      <div class="t-meta">两篇论文结构 + 本项目特征管线适配</div>
      <h2 class="page-title">复现重点是思路、结构和真实训练流程。</h2>
    </div>
    <div class="spec-grid" data-anim="up">
      <article class="spec-card accent"><div class="label">Huang 2024</div><div class="big">CNN<br/>LSTM<br/>AM</div><p class="desc">CNN 提局部模式，LSTM 建模时间依赖，attention 聚合关键时间步。</p></article>
      <article class="spec-card"><div class="label">Jiang 2026</div><div class="big">xLSTM<br/>Transformer</div><p class="desc">参考论文结构实现 xLSTM-Transformer，并适配本项目 19 维特征序列输入。</p></article>
      <article class="spec-card"><div class="label">Boundary</div><div class="big">8<br/>epoch</div><p class="desc">真实数据小规模训练验收；不把课程范围内结果说成论文完整数值对齐。</p></article>
    </div>
  </div>
</section>
...
<section class="slide" data-layout="S20" data-animate="stacked-ledger">
  <div class="canvas-card">
    ...
    <div class="head-stack" data-anim="line">
      <div class="t-meta">普通误差、论文 Score、提前 / 滞后倾向分开解释</div>
      <h2 class="page-title small">重点不是追一个好看的数，而是解释模型误差。</h2>
    </div>

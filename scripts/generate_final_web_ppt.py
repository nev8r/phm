...
<section class="slide" data-layout="S20" data-animate="stacked-ledger">
  <div class="canvas-card">
    ...
    <div class="head-stack" data-anim="line">
      <div class="t-meta">先区分普通误差、论文 Score、提前 / 滞后倾向，再解释结果边界</div>
    ...
    <div class="result-table" data-anim="up">
      ...
      <div>xLSTM-Transformer</div><div>XJTU-SY condition 1</div><div>XLSTM</div><div>2280.51</div><div>27.30</div>
      <div>xLSTM-Transformer</div><div>PHM2012 condition 3</div><div>XLSTM</div><div>1594.68</div><div>31.88</div>
    </div>

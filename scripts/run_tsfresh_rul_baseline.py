"""
Run tsfresh RUL baseline

this script compares manual 19 features and selected tsfresh features
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Run tsfresh-selected and manual-feature RUL baselines.")
...
def main() -> None:
    ...
    try:
        paths = run_tsfresh_rul_baseline(config)
